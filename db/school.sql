...
CREATE TABLE `news` (
  ...
  `subject` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主題',
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '內容',
  `type` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '類型',
  `top` tinyint(1) NOT NULL COMMENT '置頂',
  `readed` int(10) NOT NULL COMMENT '閱讀數',
